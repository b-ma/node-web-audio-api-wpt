 ...
 * @param {?Array.} curveData - Array containing values for the WaveShaper curve.
 * @param {!Array.} inputData - Array containing values for the input stream.
 * @param {!Array.} expectedData - Array containing expected results for each of the corresponding inputs.
 ...
 */
 ...
 for(var i=0;icurveData.length;i++) { curve[i]=curveData[i]; }
 ...
 for(var i=0;iinputData.length;i++) { d[i]=inputData[i]; }
 ...
 for(var i=0;iexpectedData.length;i++) {
 var curveText="null";
 if(curve!=null) {
